...
const PROMPT = `Identifica el vehículo de la foto. Responde SOLO JSON válido, sin markdown:
{"make":"marca o unknown","model":"modelo","year":"año o generación","color":"color","description":"una frase breve en español, máximo 140 caracteres","funFact":"un dato curioso verdadero en español, máximo 180 caracteres"}
Si no hay un auto claro, usa make "unknown".`;
